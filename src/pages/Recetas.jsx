...
function Recetas() {
  ...
  // Panel activo: "cerrado" | "nuevo" | "ingrediente"
  const [panel, setPanel] = useState("cerrado");

  // ── Formulario: nueva receta completa ──────────────────────────
  // El usuario elige un producto y va armando una lista de ingredientes
  // antes de guardarlos todos de una vez
  ...
  const [borradorLineas, setBorradorLineas] = useState([]); // ingredientes aún no guardados

  // ── Formulario: agregar ingrediente a receta existente ─────────
  ...
  // ── Agregar línea al borrador (sin guardar aún en BD) ──────────
  const agregarLineaBorrador = () => {
    ...
    // Evitar duplicar el mismo insumo en el borrador
  ...
  // ── Guardar toda la receta nueva en BD ─────────────────────────
  ...
  return (
    <div className="animate-in">
      ...
      {panel === "nuevo" && (
        <div className="card" style={{ marginBottom: "var(--space-lg)" }}>
          ...
          <div className="card-body">
            ...
            {/* Agregar líneas de ingredientes */}
      ...
      {/* ── Panel: agregar ingrediente a receta existente ── */}
      {panel === "ingrediente" && (
        <div className="card" style={{ marginBottom: "var(--space-lg)" }}>
          <div className="card-header">
